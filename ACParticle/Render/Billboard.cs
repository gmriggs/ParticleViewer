...
namespace ACParticle.Render
{
    public static class Billboard
    {
        ...
        static Billboard()
        {
            ...
            VertexBuffer = new VertexBuffer(ParticleViewer.Instance.GraphicsDevice, typeof(VertexPositionTexture), 4, BufferUsage.WriteOnly);
            VertexBuffer.SetData(Vertices.ToArray());

            IndexBuffer = new IndexBuffer(ParticleViewer.Instance.GraphicsDevice, typeof(short), 4, BufferUsage.WriteOnly);
