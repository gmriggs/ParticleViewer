...
using ACParticle.Render;

namespace ACParticle.Model
{
    public class GfxObj
    {
        public static GraphicsDevice GraphicsDevice { get => ParticleViewer.Instance.GraphicsDevice; }
        ...
        {
            Particle.Instance.Status.WriteLine($"Loading GfxObj {gfxObjID:X8}");
